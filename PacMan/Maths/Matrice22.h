...
public:
	...
	operator std::string () const {
		std::ostringstream o; o << "[" << std::endl << ligneHaut << std::endl << ligneBas << std::endl << "]"; return o.str();
	}

	friend std::ostream & operator << (std::ostream & o, const Matrice22 & m) { return o << (std::string)m; }
